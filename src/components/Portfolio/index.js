    ...
    const projects = [
        {
            ...
            description: ['This app allows users to create notes and write code lines while they are offline as well.'],
        ...
        },
        {
            ...
            description: ['Gauge My Coworkers platform and mobile app provide employees generated feedback on their co-workers general performance and behaviors.'],
        ...
        },
        {
            ...
            description: ['This app will help you keep track of your daily spending, while comparing your tracked balance with that of your bank account.'],
        ...
        },
        {
            ...
            description: ['This app helps the user to search for books and save them to a list so they can be found later, by signing up and logging in.'],
